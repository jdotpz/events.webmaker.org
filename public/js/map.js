define(['jquery', 'google', 'infobubble', 'markerclusterer', 'oms'],
    ...
    var seedModels = [
        { "latitude" : 37.7755105, "longitude" : -122.4413014, "organizer" : "Joey Bishop", "date" : "Thursday June 23rd", "time" : "3pm", "address" : "94117 Grove Street, San Francisco, CA", "title" : "Writing tests can be phun", "description" : "Tests can be fun if you know what your doing. Learn how here." },
